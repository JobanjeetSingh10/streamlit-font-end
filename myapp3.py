...
import plotly.figure_factory as ffSSSS
...
country = st.multiselect('Which country would you like to see?', country_options, ['India', 'United States', 'Brazil', 'United Kingdom'])
